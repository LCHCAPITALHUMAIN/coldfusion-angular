<cfcomponent client="true" >
	...
	<cffunction name="syncDB" >
		...
		<cfquery datasource="#DATASOURCE#" >
			...
			CREATE TABLE IF NOT EXISTS conference (id, title, startdate, enddate, 
			shortdesc,registrationurl);
		</cfquery>
	...
	<cffunction name="copyDB" access="private" >
		...
		<cfquery datasource="#DATASOURCE#" >
			...
			insert into conference values ("#row.id#","#row.title#","#row.startdate#","#row.enddate#
			","#row.shortdesc#","#row.registrationurl#")
		</cfquery>
	...
	<cffunction name="initDB" >
		...
		<cfloop index="i" from="1" to="5" >
			...
			<cfquery datasource="#DATASOURCE#" >
				...
				insert into conference values ("test#i#
				","CFSUMMIT2013","24/10/2013","26/10/2013","Annual ColdFusion Developer 
				Conference","")
			</cfquery>
		...
		<cfquery datasource="#DATASOURCE#" >
			...
			CREATE TABLE IF NOT EXISTS users (id,email,firstname,lastname,password, 
			twitter,blog,image)
		</cfquery>
	...
	<cffunction name="isUserRegistered" access="public" returntype="boolean" >
		...
		<cfquery name="result" datasource="#DATASOURCE#" >
			...
			select * from registration where userid=<cfqueryparam value="#userid#" >
			and confid=<cfqueryparam value="#confid#" >
