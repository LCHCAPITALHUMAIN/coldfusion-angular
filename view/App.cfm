<cfclient>
	...
	function ( $scope, $rootScope, $location ){
		return new login.loginCtrl( $scope, $rootScope, $location );
	}
	 );
		variables.app.controller( "registerCtrl", 
	function ( $scope, $rootScope, $location ){
		return new register.registerCtrl( $scope, $rootScope, $location );
	}
	 );
	...
	function ( $routeProvider, $locationProvider ){
		...
		$routeProvider.when( '/login', { templateUrl='login/login.tpl.html', controller="loginCtrl" } );
	
		$routeProvider.when( '/home', { templateUrl='home/home.tpl.html', controller="homeCtrl" } );
	
		$routeProvider.when( '/register', { templateUrl='register/register.tpl.html', controller="registerCtrl" } );
